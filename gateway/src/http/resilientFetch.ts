...
/**
 * Исходящие запросы шлюза: retry при 5xx/сети и circuit breaker по upstream
 */
...
export const CIRCUIT_GATEWAY_AUTH = "gateway-to-auth";
export const CIRCUIT_GATEWAY_USERS = "gateway-to-users";
export const CIRCUIT_GATEWAY_CREDITS = "gateway-to-credits";
export const CIRCUIT_GATEWAY_CORE = "gateway-to-core";
export const CIRCUIT_GATEWAY_ADMIN_SETTINGS = "gateway-to-admin-settings";
export const CIRCUIT_GATEWAY_CLIENT_SETTINGS = "gateway-to-client-settings";
