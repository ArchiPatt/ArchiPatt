...
export const patchUserByIdBlock = ({ config, body, path }: PatchUserByIdBlockRequestParams) => instance.request<PatchUsersByIdBlockResponse | PatchUsersByIdBlockError>({
    method: "PATCH",
