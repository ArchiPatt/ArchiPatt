...
export const getInternalUsersByUsernameByUsername = ({ config, path }: GetInternalUsersByUsernameByUsernameRequestParams) => instance.request<GetInternalUsersByUsernameByUsernameResponse | GetInternalUsersByUsernameByUsernameError>({
    method: "GET",
