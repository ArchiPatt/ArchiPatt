...
export const getAccountByIdOperations = ({ config, query, path }: GetAccountByIdOperationsRequestParams) => instance.request<GetAccountsByIdOperationsResponse | GetAccountsByIdOperationsError>({
    method: "GET",
