...
export const postAccountByIdWithdraw = ({ config, body, path }: PostAccountByIdWithdrawRequestParams) => instance.request<PostAccountsByIdWithdrawResponse | PostAccountsByIdWithdrawError>({
    method: "POST",
