...
import {useCreateCredit} from "../../../entities/Credit";
import {useMemo, useState} from "react";
import type {TariffResponse} from "../../../entities/Tariff/types/TariffResponse.ts";
import type {IssueCreditRequest} from "../../../entities/Credit/types/IssueCreditRequest.ts";
import {userStorage} from "../../../app/storage/userStorage";
import {useNavigate} from "react-router-dom";
import {LINK_PATHS} from "../../../constants/LINK_PATHS.ts";
import type {Account} from "../../../entities/Account/types/Account.ts";
