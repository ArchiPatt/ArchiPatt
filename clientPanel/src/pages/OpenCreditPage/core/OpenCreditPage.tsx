...
import { useOpenCreditPage } from "./useOpenCreditPage.ts";
...
const OpenCreditPage = () => {
    ...
    if (accountError || tariffError) return <div>Не удалось загрузить данные! Попробуйте позже</div>
                        ...
                        <Stack spacing="sm">
                            ...
                            <Box>
                                ...
                                <Text size="lg" weight={500}>
                                    {choosenTariff && filteredTariff.find(item => item.id === choosenTariff)?.interestRate * 100}%
                                </Text>
                            </Box>
